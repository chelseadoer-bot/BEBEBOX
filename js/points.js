 ...
 *   모으기: 인스타(핀핀) 이벤트 참여 +100(캠페인 메인), 기록 +20, 공유 +30,
 *           선물 받으면 +50, 좋아요 200개마다 +10
 *   쓰기:   AI 콘텐츠/게임 결과 1회 이용 -10 (매 이용마다)
 *   교환:   100캔디 → 키디키디 3,000원 상품권
 *   (참고: 초기안은 100포인트=1,000원 기프티콘·주간 최대 3,000원 제한이었음)
 *
...
const POINT_RULES = {
  ...
  gameCost: 10, // AI 콘텐츠/게임 결과 1회 이용(차감)
