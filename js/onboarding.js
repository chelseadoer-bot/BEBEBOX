...
function bindOnboarding(){
  ...
  $("#btn-login-kakao")?.addEventListener("click",()=>obLogin("kakao"));
  $("#btn-login-naver")?.addEventListener("click",()=>obLogin("naver"));
  $("#btn-login-apple")?.addEventListener("click",()=>obLogin("apple"));
