...
CONCEPTS = {
    ...
    "picnic": {
        "label": "피크닉 스튜디오",
        "emoji": "🧺",
        "desc": "화창한 날 소풍 나온 감성 화보",
        "scene": (
            "- 화창한 봄/여름날 잔디밭 피크닉 컨셉 화보\n"
            "- 배경은 초록 잔디밭, 체크무늬 피크닉 매트, 등나무 바구니, 꽃과 나무가 있는 야외 포토존\n"
            "- 맑고 따뜻한 자연광\n"
            "- 아기는 소풍 나온 편안하고 사랑스러운 나들이 옷 착용\n"
            "- 작은 도시락, 과일, 꽃 소품으로 포인트"
        ),
        "mood": "피크닉 컨셉으로 촬영한 화사하고 사랑스러운 나들이 화보",
    },
    "rainy": {
        "label": "비 오는 날 스튜디오",
        "emoji": "🌧️",
        "desc": "우비 입고 빗속을 즐기는 감성 화보",
        "scene": (
            "- 비 오는 날 감성의 컨셉 화보\n"
            "- 배경은 촉촉하게 젖은 거리와 물웅덩이, 우산과 장화, 은은한 회청색 빗속 분위기의 포토존\n"
            "- 부드럽고 차분한 흐린 날 조명\n"
            "- 아기는 귀여운 레인코트(우비)와 장화 착용\n"
            "- 작은 우산, 물웅덩이 반영 소품으로 포인트"
        ),
        "mood": "비 오는 날 컨셉으로 촬영한 사랑스럽고 감성적인 우중 화보",
    },
}
...
def build_prompt(concept, has_outfit=False):
    c = CONCEPTS.get(concept) or CONCEPTS[DEFAULT_CONCEPT]
    outfit = ""
    if has_outfit:
        outfit = (
            "\n[👕 의상 — 필수 지정]\n"
            "- 두 번째로 첨부된 '옷 참고 이미지'의 의상을 아기에게 그대로 입혀 줘.\n"
            "- 옷의 디자인·색상·패턴·형태(상의/하의/모자/신발 포함)를 최대한 동일하게 재현.\n"
            "- 옷만 참고 이미지에서 가져오고, 얼굴과 인상은 첫 번째 아기 사진 그대로 유지.\n"
        )
    return (
